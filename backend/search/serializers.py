...
class SearchMatchSerializer(serializers.Serializer):
    ...
    context = serializers.CharField(required=False, allow_null=True, allow_blank=True, default="", help_text="Context for the text")  # type: ignore[assignment]
...
class SearchResultSerializer(serializers.Serializer):
    ...
    experiences = JobExperienceSerializer(
        many=True,
        required=False,
        allow_null=True,
        help_text="List of experiences"
    )
    education = serializers.ListField(
        child=serializers.DictField(),
        required=False,
        allow_null=True,
        help_text="List of education"
    )
    ...
    location = serializers.DictField(
        required=False,
        allow_null=True,
        help_text="Location information"
    )
    desired_role = serializers.CharField(
        required=False,
        allow_null=True,
        help_text="Desired role"
    )
...
class SearchFiltersSerializer(serializers.Serializer):
    ...
    skills = serializers.ListField(
        ...
        required=False,
        allow_null=True,
        help_text="Skills to filter by"
    )
    technologies = serializers.ListField(
        child=serializers.CharField(),
        required=False,
        allow_null=True,
        help_text="Technologies to filter by"
    )
    role = serializers.CharField(
        required=False,
        allow_null=True,
        help_text="Desired role to filter by"
    )
    company = serializers.CharField(
        required=False,
        allow_null=True,
        help_text="Company to filter by"
    )
    location = serializers.CharField(
        required=False,
        allow_null=True,
        help_text="Location to filter by"
    )
    years_experience = serializers.IntegerField(
        required=False,
        allow_null=True,
...
class VectorSearchQuerySerializer(serializers.Serializer):
    ...
    filters = SearchFiltersSerializer(
        required=False,
        help_text="Optional filters for search"
    )
...
class GraphSearchQuerySerializer(serializers.Serializer):
    query = serializers.CharField(
        ...
        allow_blank=True,
        default="",
        help_text="Optional query (not used for structured search)"
    )
    filters = SearchFiltersSerializer(
        required=False,
