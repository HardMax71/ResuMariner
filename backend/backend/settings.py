...
SECRET_KEY = os.getenv("SECRET_KEY", "insecure-default-key-for-development-only")
...
MIDDLEWARE = [
    ...
    "core.middleware.SearchServicesMiddleware",
...
API_DEFAULT_LIST_LIMIT = int(os.getenv("API_DEFAULT_LIST_LIMIT", "100"))
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Resume Processing and Search API",
    "VERSION": "1.0.0",
...
neomodel_config.MAX_CONNECTION_POOL_SIZE = NEO4J_MAX_CONNECTION_POOL_SIZE
neomodel_config.MAX_CONNECTION_LIFETIME = NEO4J_MAX_CONNECTION_LIFETIME
neomodel_config.CONNECTION_TIMEOUT = NEO4J_CONNECTION_TIMEOUT
neomodel_config.MAX_TRANSACTION_RETRY_TIME = NEO4J_MAX_TRANSACTION_RETRY_TIME
...
QDRANT_COLLECTION = os.getenv("QDRANT_COLLECTION", "resume_key_points")
...
REDIS_SCAN_BATCH_SIZE = int(os.getenv("REDIS_SCAN_BATCH_SIZE", "100"))
REDIS_STREAM_READ_COUNT = int(os.getenv("REDIS_STREAM_READ_COUNT", "10"))
REDIS_STREAM_BLOCK_MS = int(os.getenv("REDIS_STREAM_BLOCK_MS", "5000"))
REDIS_RETRY_BASE_DELAY = int(os.getenv("REDIS_RETRY_BASE_DELAY", "1"))
REDIS_RETRY_MAX_DELAY = int(os.getenv("REDIS_RETRY_MAX_DELAY", "100"))
WORKER_CONCURRENT_JOBS = int(os.getenv("WORKER_CONCURRENT_JOBS", "10"))
REDIS_JOB_PREFIX = os.getenv("REDIS_JOB_PREFIX", "resume:job:")
...
LLM_CIRCUIT_BREAKER_FAIL_MAX = int(os.getenv("LLM_CIRCUIT_BREAKER_FAIL_MAX", "5"))
LLM_CIRCUIT_BREAKER_RESET_TIMEOUT = int(os.getenv("LLM_CIRCUIT_BREAKER_RESET_TIMEOUT", "60"))
...
if TEXT_LLM_API_KEY:
    os.environ[f"{TEXT_LLM_PROVIDER.upper()}_API_KEY"] = TEXT_LLM_API_KEY
if TEXT_LLM_BASE_URL:
    os.environ[f"{TEXT_LLM_PROVIDER.upper()}_BASE_URL"] = TEXT_LLM_BASE_URL

if OCR_LLM_PROVIDER != TEXT_LLM_PROVIDER and OCR_LLM_API_KEY:
    os.environ[f"{OCR_LLM_PROVIDER.upper()}_API_KEY"] = OCR_LLM_API_KEY
    if OCR_LLM_BASE_URL:
...
REDIS_JOB_TTL = int(os.getenv("REDIS_JOB_TTL", "86400"))  # 24 hours
...
TEMP_DIR = os.getenv("TEMP_DIR", "/tmp/resume_uploads")
